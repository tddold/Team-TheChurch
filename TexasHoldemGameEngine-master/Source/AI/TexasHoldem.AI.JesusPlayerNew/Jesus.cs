namespace TexasHoldem.AI.JesusPlayerNew
{
    using System;
    using Helpers;
    ...
    public class Jesus : BasePlayer
    {
        ...
        public override PlayerAction GetTurn(GetTurnContext context)
        {
            ...
            return this.GetActionByCardValuationType(strengthOfHand, context);
        }
        ...
        private PlayerAction GetActionByCardValuationType(CardValuationType playHand, GetTurnContext context)
        {
            ...
            {
                return this.ChooseAction(context.MoneyLeft, 0.2f);
            }
            ...
            {
                return this.ChooseAction(context.MoneyLeft, 0.4f);
            }
        ...
        {
            var bet = this.GetBet(leftMoney, percent);
