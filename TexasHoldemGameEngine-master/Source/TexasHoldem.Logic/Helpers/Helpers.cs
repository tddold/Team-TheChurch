namespace TexasHoldem.Logic.Helpers
{
    ...
    public static class Helpers
    {
        ...
        /// <summary>
        /// Finds the best possible hand given a player's cards and all revealed community cards.
        /// </summary>
        /// <param name="cards">A player's cards + all revealed community cards</param>
        ...
        /// </summary>
        /// <param name="firstPlayerCards">First player cards + all revealed community cards</param>
        /// <param name="secondPlayerCards">Second player cards + all revealed community cards</param>
